...
@else
<a class="btn-teal btn rounded-pill px-4 ml-lg-4" href="/register">Sign in<i class="fas fa-arrow-right ml-1"></i></a>
<a class="btn-teal btn rounded-pill px-4 ml-lg-4" href="/login">Sign up<i class="fas fa-arrow-right ml-1"></i></a>
                                @endauth
